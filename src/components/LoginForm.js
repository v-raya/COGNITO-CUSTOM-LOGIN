...
const LoginForm = ({onSubmit, errorMsg, successMessage, email, password,
  onEmailChange, onPasswordChange, disableSignIn, inputRef}) => {
  return (
    <form>
      ...
      <input id='email' ref={inputRef} name='email' type='text' className='form-control inputField-customizable'
