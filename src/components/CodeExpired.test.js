...
describe('CodeExpired.js Tests', () => {
  ...
  describe('instructions Tests', () => {
    it('should display instructions', () => {
      ...
      expect(span.at(0).text()).toEqual('Please return to the login screen and re-enter your login information.')
      expect(span.at(1).text()).toEqual('A new code will be sent to your email.')
    })
  })
